...
| src/routes/batch_operations.rs    | 76.26% | 51.79%     | 68.66%   | 2026-09-15 | [ACCEPTED]       | OS file picker dialog + live Tauri event emitter glue; core batch dispatch fully tested |
...
| src/routes/settings.rs            | 75.56% | 56.82%     | 67.59%   | 2026-09-15 | [ACCEPTED]       | Thin glue / Tauri command wrappers + OS folder picker dialog; core settings persistence & Gemini validation fully tested in services |
...
| src/services/fingerprint.rs       | 92.35% | 72.00%     | 90.94%   | 2026-09-15 | [ACCEPTED]       | High line/region coverage (>=90%); function gap due to compiler-derived struct traits; OS/Filesystem |
...
| src/lib/views/ImportView.svelte           | 93.24%          | 93.29%              | 75.59%                     | 2026-09-15 | [ACCEPTED]       | High line/function coverage (>93%); residual branch gaps in wizard navigation & modal states |
| src/lib/views/ProjectsView.svelte         | 98.61%          | 94.20%              | 85.45%                     | 2026-09-15 | [ACCEPTED]       | Retained for completeness; all metrics >= 80%                                               |
| src/lib/views/ReferenceDataView.svelte     | 93.33%          | 94.11%              | 72.22%                     | 2026-09-15 | [ACCEPTED]       | High line/function coverage (>93%); container tab switcher branches; child views fully tested |
