...
fn setting_description_for_key(key: &str) -> &'static str {
    match key {
        ...
        KEY_BACKUP_DATABASE_LAST_RUN_AT => "Timestamp of the last successful database backup.",
        KEY_BACKUP_DESIGNS_LAST_RUN_AT => "Timestamp of the last successful designs backup.",
        _ => "",
    }
}
